...
@section('content')
  ...
  <div class="main-panel">
          <div class="content-wrapper">
            ...
            @if (session()->pull('loginStatus'))
            <div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>Success!</strong> Great! You have Successfully loggedin
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{ url('public/admin') }}/assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-6 pr-1">
                        <img src="{{ url('public/admin') }}/assets/images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="assets/images/dashboard/img_4.jpg" class="mw-100 w-100 rounded" alt="image">
                      </div>
                      <div class="col-6 pl-1">
                        <img src="{{ url('public/admin') }}/assets/images/dashboard/img_2.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{ url('public/admin') }}assets/images/dashboard/img_3.jpg" class="mw-100 w-100 rounded" alt="image">
                      </div>
                    </div>
                    <div class="d-flex mt-5 align-items-top">
                      <img src="{{ url('public/admin') }}/assets/images/faces/face3.jpg" class="img-sm rounded-circle mr-3" alt="image">
